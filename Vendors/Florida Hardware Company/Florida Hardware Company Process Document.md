# **VENDOR - FLORIDA HARDWARE (Main Warehouse)**
...
Table 2 - Vendor Accounts & Submission Schedule
...
### **1.1 Vendor Overview**
  ...
  - > Florida Hardware vendor orders are processed via Vendor Website only.
...
| **Submission Day** | **Expected ETA**        |
| ------------------ | ----------------------- |
| Monday, Tuesday    | Friday (same week)      |
| Thursday, Friday   | Friday (following week) |
...
Table 2 - Vendor Accounts

| **Account** | **Username**              | **Used On**                         |
| ----------- | ------------------------- | ----------------------------------- |
| Account 1   | user\_218 (dkpurchasing)  | All processing days except Thursday |
| Account 2   | user\_228 (dkpurchasing2) | Thursday only                       |

### **1.3.2 Special Rules & Restrictions**

#### → Thursday-Specific Rules (Account 2)

  - > When using **user\_228 (Thursday)**:
...
Before submission:
  ...
  - > Cart page total **must match** checkout page total

  - > A variance of **a few cents is acceptable**
